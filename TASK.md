...
This is the README that ships with [teamrudra/R27-Test](https://github.com/teamrudra/R27-Test),
reproduced verbatim at commit `147d61e` so nothing from the brief is lost.
My own write-up lives in [README.md](README.md).
